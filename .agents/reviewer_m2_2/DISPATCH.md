...
You are Reviewer 2 for Milestone 2: Material Penetration System in TacticalSim.
Working directory for metadata/reports: c:\Users\jdwil\source\repos\Codex\1bal\.agents\reviewer_m2_2
...
Tasks:
1. Objectively and independently review the code written for Milestone 2:
...
2. Check edge cases: zero thickness, zero velocity, collinear surface normal, perpendicular impact, grazing angles near ricochet threshold, extreme densities, custom registered materials.
3. Run `dotnet test` and build checks.
4. Provide an explicit verdict: `APPROVE` or `REQUEST_CHANGES`.
5. Write your full report to `c:\Users\jdwil\source\repos\Codex\1bal\.agents\reviewer_m2_2\handoff.md` and send a summary message back.
