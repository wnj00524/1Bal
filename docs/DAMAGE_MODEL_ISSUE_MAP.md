...
| ID | GitHub issue | Milestone | Initial status |
|---|---|---|---|
| DM-001 | [Adopt a typed-unit strategy](https://github.com/wnj00524/1Bal/issues/108) | M5: Damage-model foundations | Backlog |
| DM-002 | [Add a projectile energy ledger](https://github.com/wnj00524/1Bal/issues/109) | M5: Damage-model foundations | Backlog |
| DM-003 | [Introduce canonical wound-track contracts](https://github.com/wnj00524/1Bal/issues/110) | M5: Damage-model foundations | Backlog |
